...
class OTOCOOrder(Order):
    ...
    def to_dict(
        ...
        child_a: dict | None = None,
        child_b: dict | None = None,
        ...
        if child_a:
            ...
            s["child_a"] = self.child_a.to_dict(s)
        ...
        if child_b:
            ...
            s["child_b"] = self.child_b.to_dict(s)
    ...
    def from_dict(
        ...
        if is_child:
            ...
            parent_order = OTOCOOrder.from_dict(parent, is_child=True)
        ...
        if is_child:
            ...
            child_a_order = OTOCOOrder.from_dict(child_a, is_child=True)
        ...
        if is_child:
            ...
            child_b_order = OTOCOOrder.from_dict(child_b, is_child=True)
        ...
        if is_counterparty:
            ...
            counterparty_order = OTOCOOrder.from_dict(
