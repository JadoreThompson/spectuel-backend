...
def test_otoco_flow(spot_engine, test_ctx, user_id_a, user_id_b, command_id):
    """
    Full Flow:
    ...
    # 1. Setup
    spot_engine._balance_manager.increase_cash_balance(user_id_a, 2000, command_id)  # Buy 10 @ 90
